...
维护柠檬爱美业务的医生、医院等 B 端前端项目。

### 便利蜂 - 前端工程师 (2018.07-2020.03)

维护内部办公软件的 APP 和 PC 前端 / 监控报警平台前端 / 营建管理前端 / 基于 MQTT.js 消息平台的 npm 包等，使用 react / react-native / mobx / electron 等。
...
> **T** 提升稳定性和性能，监控异常与崩溃，完善应用的功能，以用户行为埋点驱动需求迭代。
...
> **R** 直接反馈软件崩溃、严重卡顿的用户基本消失，JS 端的崩溃接入报警。为用户提供更多提高办公效率的功能，以用户行为的埋点驱动需求迭代。

* 公司办公软件 iOS、Android 端相关需求

> **S** 公司 IM 应用 iOS、Android 端，拥有工作流、即时通信等功能，面向总部、店员。
